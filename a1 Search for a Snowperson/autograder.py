...
if __name__ == '__main__':
    if test_time_astar:
        ...
        time_bound = 3
        p = multiprocessing.Process(target=anytime_weighted_astar, name="Anytime A star", args=(
    ...
    if test_time_gbfs:
        ...
        time_bound = 3
        q = multiprocessing.Process(target=anytime_gbfs, name="Anytime GBFS", args=(
            PROBLEMS[19], heur_alternate, time_bound))
        q.start()
    ...
    if test_manhattan:
        ...
        correct_man_dist = [14, 9, 4, 11, 5, 5, 6, 7,
                            9, 5, 9, 9, 4, 24, 17, 5, 16, 25, 14, 14]
    ...
    if test_alternate:
        ...
        lengths = [54, 82, 30, 49, 71, 68, 29, 47, 38, 30,
                   68, 76, 53, -99, -99, 117, -99, -99, 64, -99]
        ...
        print("The benchmark implementation solved {} out of {} practice problems given {} seconds.".format(
    ...
    if test_fval_function:
        ...
        test_state = SnowmanState("START", 6, None, 8, 10, (2, 2), {(2, 1): 0, (4, 3): 1, (
            1, 8): 2}, frozenset(((2, 3), (3, 0), (5, 1), (1, 3), (1, 2), (4, 5))), (4, 1))
        ...
        for i in range(len(weights)):
            ...
            print('Test', str(i), 'calculated fval:', str(
                fval), 'correct:', str(correct_fvals[i]))

            if fval == correct_fvals[i]:
                solved += 1

        print("\n*************************************")
        print("Your fval_function calculated the correct fval for {} out of {} tests.".format(
    ...
    if test_anytime_gbfs:
        ...
        len_benchmark = [44, 47, 19, 36, 35, 60, 18, 22, 34,
                         28, 32, 43, 35, -99, -99, 40, -99, -99, 44, -99]
        ##############################################################
        # TEST ANYTIME GBFS
        ...
        for i in range(0, len(PROBLEMS)):
            ...
            s0 = PROBLEMS[i]  # Final problems are hardest
            final = anytime_gbfs(
                s0, heur_fn=heur_alternate, timebound=timebound)
        ...
        print("Of the {} problems that were solved, the cost of {} matched or outperformed the benchmark.".format(
            solved, benchmark))
        print("Problems that remain unsolved in the set are Problems: {}".format(unsolved))
        print("The benchmark implementation solved {} out of the 20 practice problems given {} seconds.".format(
            15, timebound))
        print("*************************************\n")
