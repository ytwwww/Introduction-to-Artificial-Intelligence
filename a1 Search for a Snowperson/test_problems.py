...
PROBLEMS = (
    # Problem 0,
    SnowmanState("START", 0, None, 8, 10,
                 (2, 2),
                 {(2, 1): 0, (4, 3): 1, (1, 8): 2},
                 frozenset(((2, 3), (3, 0), (5, 1), (1, 3), (1, 2), (4, 5))),
                 (4, 1),),
    # Problem 1,
    SnowmanState("START", 0, None, 6, 4,
                 (2, 0),
                 {(1, 2): 0, (4, 1): 1, (3, 2): 2},
                 frozenset(((2, 3), (2, 2))),
                 (5, 1),),
    ...
    SnowmanState("Start", 0, None, 6, 7,  # dimensions
                 ...
                 frozenset(((1, 2), (1, 3), (1, 4), (1, 5), (1, 6),
                            (2, 2), (5, 1), (5, 0))),  # obstacles
                 (2, 3),  # destination
                 ),
    # Problem 7,
    SnowmanState("Start", 0, None, 6, 4,  # dimensions
    ...
    SnowmanState("START", 0, None, 9, 6,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(2, 7, 2, 3) + \
                            generate_coordinate_rect(2, 3, 2, 6))),  # obstacles
                 (2, 0),  # destination
                 ),
    # Problem 17
    SnowmanState("START", 0, None, 10, 7,  # dimensions
                 ...
                 frozenset((generate_coordinate_rect(2, 8, 2, 3) + \
                            generate_coordinate_rect(2, 3, 2, 7))),  # obstacles
                 (2, 0),  # destination
                 ),
    # Problem 18
    SnowmanState("Start", 0, None, 6, 5,  # dimensions
